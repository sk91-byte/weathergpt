  ...
  return (
    <div className="min-h-screen overflow-y-auto bg-slate-50 text-slate-900 pb-10">
      ...
      <main className="mx-auto max-w-md space-y-4 p-4">
        {activeAlerts.length > 0 ? <section className={`rounded-3xl border-2 p-4 shadow-sm ${primaryAlertIsNearby ? 'border-red-300 bg-red-50' : 'border-amber-300 bg-amber-50'}`}>
        ...
        </section> : <section className="rounded-3xl border border-emerald-200 bg-emerald-50 p-4 shadow-sm"><p className="text-xs font-black uppercase tracking-wide text-emerald-700">✅ No disaster alert noticed</p><p className="mt-1 text-sm font-semibold text-slate-800">No active official disaster alert was found within 10 km of the sampled route points.</p></section>}
        {activeAlerts.length > 0 && <section className="rounded-3xl border border-slate-300 bg-white p-4 shadow-sm">
