...
Gemini and Groq integrations are optional for `/chat`, translation/explanation, and voice. Set the relevant API keys in `backend/.env` to enable them. The weather and alert providers remain the source of truth.
